...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      <div className="flex flex-row py-[6px] px-4 items-center bg-discount-gradient rounded-[10px] mb-2">
    ...
    <div className={`flex flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[1] w-4/5 h-4/5 bottom-40 rounded-full white__gradient" />
